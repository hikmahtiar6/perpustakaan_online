...
/*
     ...
     Copyright (c) : 2013 ,
     script : tambah_anggota.php ,
     All rights reserved.
*/
--->

<title></title><h2>Form Daftar Anggota</h2>
<form method="post" action="<?php echo base_url()?>administrator/signup">
<table>
    <tr height="40">
        <td>Nama</td>
        ...
        <td>
            <select style="border:none;padding:5px;width:250px;border:1px solid #666;" name="status">
                ...
                <option style="padding:5px;">
                    Siswa - Siswi SMK Negeri 4 Kota Bogor
                </option>
                <option style="padding:5px;">
                    Alumni SMK Negeri 4 Kota Bogor
                </option>
                <option style="padding:5px;">
                    Guru SMK Negeri 4 Kota Bogor
                </option>
            </select>
        </td>
    </tr>
