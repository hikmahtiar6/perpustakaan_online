...
*/--->
    ...
    <div class="nav-outer"> 
            ...
            <div id="nav-right">
                ...
                <div class="nav-divider">&nbsp;</div>
                <a href="<?php echo base_url()?>anggota/logout" name="log" id="logout" onClick="return confirm('Apakah Anda Yakin Ingin Keluar?')"><img src="<?php echo base_url()?>plugin/administrator/images/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
                <div class="clear">&nbsp;</div>
