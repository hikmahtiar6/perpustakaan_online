...
<tr>
    ...
    <div id="content-table-inner">
            ...
            <a style="padding: 10px;background: #0a9aff;position: relative;margin-bottom: 10px;border-radius:7px;color: #FFF;font-weight:bold;" id="pancibox3" href="<?php echo base_url()?>administrator/tambah_ebook">Tambah File</a>
...
<?php $no=1; foreach($sql as $row) { $tgl = substr($row->tanggal,8,2).substr($row->tanggal,4,4).substr($row->tanggal,0,4);?>
            <tr style="background:#f3f3f3;text-align: center;">
                            ...
                            <td><?php echo $tgl?></td>
                            <td>
                                <a id="pancibox2" href="<?php echo base_url()?>administrator/edit_ebook/<?php echo $row->id?>/<?php echo md5($row->id).".html"?>" title="Edit"><img src="<?php echo base_url()?>plugin/administrator/images/admin/icons/edit.png" width="20"></a>
                                <span style="margin-left: 5px;">&nbsp;</span>
                                <a onclick="return confirm('Apakah Anda Yakin Akan Menghapus Ini?')" href="<?php echo base_url()?>administrator/delete_ebook/<?php echo $row->id?>/<?php echo md5($row->id).".html"?>" title="Delete"><img src="<?php echo base_url()?>plugin/administrator/images/admin/icons/delete.png" width="20"></a>
                            </td>
                        </tr><?php $no++; } ?>
