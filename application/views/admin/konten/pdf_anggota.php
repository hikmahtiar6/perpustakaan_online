...
$this->fpdf->Cell(27,1,'LAPORAN DATA ANGGOTA',0,0,'C');
...
$this->fpdf->Cell(4  , 1, 'NAMA'           , 1, 'LR', 'L');
$this->fpdf->Cell(5 , 1, 'USERNAME' , 1, 'LR', 'L');
$this->fpdf->Cell(7.5 , 1, 'STATUS' , 1, 'LR', 'L');
$this->fpdf->Cell(6 , 1, 'EMAIL' , 1, 'LR', 'L');
$this->fpdf->Cell(4 , 1, 'TELEPON' , 1, 'LR', 'L');

/* generate hasil query disini */
$no=1;foreach($anggota->result() as $data)
{
    $this->fpdf->Ln();
