...
$this->fpdf->Ln(1);
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(19,1,'LAPORAN DATA KATEGORI BUKU',0,0,'C');


/* setting header table */
$this->fpdf->Ln(1);
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(3  , 1, 'NO'           , 1, 'LR', 'L');
$this->fpdf->Cell(7  , 1, 'KODE'           , 1, 'LR', 'L');
$this->fpdf->Cell(9 , 1, 'NAMA KATEGORI BUKU' , 1, 'LR', 'L');

/* generate hasil query disini */
$no=1;foreach($kategori->result() as $data)
{
    $this->fpdf->Ln();
...
$this->fpdf->Output("data_kategori_buku.pdf","I");
?>