...
config.smiley_images = [
    ...
    config.filebrowserBrowseUrl = '../plugin/images/website/';
	config.filebrowserImageBrowseUrl = '../plugin/images/website/fotobarang/';
	config.filebrowserFlashBrowseUrl = '../plugin/images/website/';
	config.filebrowserUploadUrl = '../plugin/images/website/';
	config.filebrowserImageUploadUrl = '../plugin/images/website/';
	config.filebrowserFlashUploadUrl = '../plugin/images/website/';
